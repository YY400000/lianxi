...
class Console:
    ...
    def _collect_renderables(
        ...
        *,
        ...
        Args:
            ...
            sep (str): String to write between print config_data.
            end (str): String to write at end of print config_data.
    ...
    def out(
        ...
        *objects: Any,
        ...
        Args:
            sep (str, optional): String to write between print config_data. Defaults to " ".
            end (str, optional): String to write at end of print config_data. Defaults to "\\\\n".
    ...
    def print_json(
        ...
        *,
        ...
        Args:
            ...
            data (Any): If json is not supplied, then encode this config_data.
        ...
        if json is None:
            ...
            if not isinstance(json, str):
                raise TypeError(
                    f"json must be str. Did you mean print_json(config_data={json!r}) ?"
                )
