...
class UniversalDetector:
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> None:
        ...
        ``UniversalDetector`` more config_data, or if it has made a prediction
        ...
        if not self._got_data:
            # If the config_data starts with BOM, we know it is UTF
    ...
    def close(self) -> ResultDict:
        ...
        if not self._got_data:
            self.logger.debug("no config_data received!")
