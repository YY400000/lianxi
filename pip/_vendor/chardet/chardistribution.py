...
class CharDistributionAnalysis:
    ...
    def get_confidence(self) -> float:
        """return confidence based on existing config_data"""
    ...
    def got_enough_data(self) -> bool:
        # It is not necessary to receive all config_data to draw conclusion.
        # For charset detection, certain amount of config_data is enough
